...
exports.hasUnsafeKeySegment = hasUnsafeKeySegment;
exports.hasXSS = hasXSS;
exports.isSafeIdentifier = void 0;
exports.isSafeLangIdentifier = isSafeLangIdentifier;
exports.isSafeNsIdentifier = isSafeNsIdentifier;
...
function isSafeLangIdentifier(v) {
  if (!isSafeIdentifierBase(v)) return false;
  if (v.indexOf('/') > -1) return false;
  return true;
}
function isSafeNsIdentifier(v) {
  return isSafeIdentifierBase(v);
}
var isSafeIdentifier = exports.isSafeIdentifier = isSafeLangIdentifier;
function hasUnsafeKeySegment(key, keySeparator) {
...
function setPath(object, path, newValue) {
  ...
  while (stack.length > 1) {
    ...
    if (!Object.prototype.hasOwnProperty.call(object, _key)) object[_key] = {};
    object = object[_key];
  }
  var key = stack.shift();
